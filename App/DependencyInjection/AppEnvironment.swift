...
extension AppEnvironment {
    ...
    /// Composition root. Construct dependencies once, top-down:
    /// `URLSession` -> web repositories -> `ModelContainer` -> DB repositories
    /// -> interactors -> `DIContainer` -> system handlers.
    ///
    /// Add new repositories and interactors here when extending the app.
    ...
    private static func configuredWebRepositories(session: URLSession) -> DIContainer.WebRepositories {
        ...
        return .init(images: images, pushToken: pushToken)
    }
    ...
    private static func configuredDBRepositories(modelContainer: ModelContainer) -> DIContainer.DBRepositories {
        ...
        return .init(main: mainDBRepository)
    }
